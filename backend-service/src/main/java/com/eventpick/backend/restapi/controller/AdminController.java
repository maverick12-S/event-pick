...
@Validated
@Tag(name = "管理 (Admin)", description = "システム管理者向け全管理機能")
public class AdminController {
    ...
    @Operation(summary = "[管理] 企業ステータス変更")
    ...
    @Operation(summary = "[管理] お問い合わせクローズ")
    ...
    @Operation(summary = "[管理] アクティビティログ一覧")
    ...
    @Operation(summary = "[管理] 一般ユーザー削除予約")
    ...
    @Operation(summary = "[管理] 拠点アカウント一覧")
    ...
    @Operation(summary = "[管理] 拠点アカウント詳細")
    ...
    @Operation(summary = "[管理] 拠点アカウント停止")
    ...
    @Operation(summary = "[管理] 拠点アカウント削除予約")
